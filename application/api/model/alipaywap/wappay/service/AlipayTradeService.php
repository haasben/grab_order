...
require dirname ( __FILE__ ).DIRECTORY_SEPARATOR.'./../../aop/request/AlipayTradeWapPayRequest.php';
require dirname ( __FILE__ ).DIRECTORY_SEPARATOR.'./../../aop/request/AlipayTradeQueryRequest.php';
require dirname ( __FILE__ ).DIRECTORY_SEPARATOR.'./../../aop/AopClient.php';
